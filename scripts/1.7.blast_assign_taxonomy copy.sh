...
if [ ! -f "$seqkit_path" ]; then
    ...
    wget -O $seqkit_path https://github.com/shenwei356/seqkit/releases/download/v0.16.1/seqkit_linux_amd64.tar.gz
    tar -xzf $seqkit_path -C /home/people/23203786/tools/seqkit
    seqkit_path="/home/people/23203786/tools/seqkit"
fi
