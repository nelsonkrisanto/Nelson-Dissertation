...
def map_semi_nested_inner_to_outer(outer_df, inner_df):
    combined_results = []
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 4:
        print("Usage: python combine_semi_nested_insilico_results.py outer_results_file inner_results_file combined_output_file")
        sys.exit(1)
    ...
    combined_df = map_semi_nested_inner_to_outer(outer_df, inner_df)
