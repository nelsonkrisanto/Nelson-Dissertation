...
file_path = r'C:\Users\Nelso\OneDrive\Documents\Thesis\data\individual_conv_primer_combination_details.tsv'
...
grouped = df.groupby(['Region', 'Genotype_Forward']).size().unstack(fill_value=0)
...
output_file = r'C:\Users\Nelso\OneDrive\Documents\Thesis\regions_heatmap_combined_labeled_v4.png'
